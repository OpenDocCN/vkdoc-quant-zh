...
![](img/605529_1_En_7_Fig6_HTML.jpg)
...
![](img/605529_1_En_7_Fig7_HTML.jpg)
...
![图 7-8](img/605529_1_En_7_Fig8_HTML.jpg)
...
我们还可以通过使用`loc()函数`对更粗略的日期索引进行子集选取，来限制`DataFrame`的范围。例如，以下代码返回 2023 年 1 月每只股票的最大回撤及其对应日期：
