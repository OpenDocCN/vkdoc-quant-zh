...
![](img/605529_1_En_3_Fig1_HTML.jpg)
...
![](img/605529_1_En_3_Fig2_HTML.jpg)
...
![](img/605529_1_En_3_Fig3_HTML.jpg)
...
![$$ {F}_0={S}_0{e}^{rT} $$](img/605529_1_En_3_Chapter_TeX_Equa.png)
...
有趣的是，股票头寸和现金头寸共同构成了一个复制投资组合，该组合抵消了远期合约在交割日收益函数中的随机性。这意味着，无论未来远期合约的价格如何，我们总能利用另一个复制投资组合来提供相同的收益，*仿佛*我们身处远期合约的多头头寸中。这被称为通过复制进行定价。
...
*一个带有变量标注的合理价格等式。F 等于 S t 乘以 1 加 r 加 s 减 c 的 T 减 t 次幂。标注的变量分别为：合理价格、标的资产现货价格、按年复利的利率、便利收益、存储成本以及按年计算的期限。*
